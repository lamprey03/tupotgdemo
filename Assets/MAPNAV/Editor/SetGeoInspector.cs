...
public class SetGeoInspector : Editor {
	...
	public override void OnInspectorGUI () {
		...
		EditorGUILayout.PropertyField (scaleX, new GUIContent ("scale X:"), GUILayout.MaxWidth (250));
		EditorGUILayout.PropertyField (scaleY, new GUIContent ("scale Y:"), GUILayout.MaxWidth (250));
		EditorGUILayout.PropertyField (scaleZ, new GUIContent ("scale Z:"), GUILayout.MaxWidth (250));
		EditorGUILayout.Space();
